...
gcc -std=c2x -g -Wall -Wextra -o $executable ../src/nerd_utils.c ../src/literal.c ../src/scene.c\
 ...
 ../src/knowledge_base.c ../src/sensor.c ../src/nerd.c ../test/helper/rule_queue.c ../test/nerd.c\
 -lcheck -lm -L../libs/pcg-c-0.94/src -lpcg_random -I../libs/pcg-c-0.94/include
cd ../src/
if $executable; then
    printf "\n"
