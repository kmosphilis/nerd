...
START_TEST(add_rule_test) {
  ...
  RuleQueue *rule_queue1 = create_rule_queue1(), *rule_queue2 = NULL,
            *rule_queue3 = rule_queue_constructor(true), *inactive_rules;
  ...
  for (i = 0; i < rule_queue1->length; ++i) {
    ck_assert_int_eq(
        knowledge_base_add_rule(knowledge_base, &(rule_queue1->rules[i])), 1);
    ck_assert_int_eq(
        knowledge_base_add_rule(knowledge_base, &(rule_queue3->rules[i])), 0);
  }
  ...
  rule_queue_destructor(&inactive_rules);
  ck_assert_int_eq(
      knowledge_base_add_rule(knowledge_base, &(rule_queue2->rules[0])), 0);
  ...
  for (i = 0; i < rule_queue3->length; ++i) {
    ck_assert_int_eq(
        knowledge_base_add_rule(knowledge_base, &(rule_queue3->rules[i])), 1);
  }
  ...
  ck_assert_ptr_null(knowledge_base);
  ck_assert_int_eq(
      knowledge_base_add_rule(knowledge_base, &(rule_queue2->rules[0])), -1);
  ck_assert_ptr_null(knowledge_base);
...
START_TEST(copy_test) {
  KnowledgeBase *knowledge_base1 = knowledge_base_constructor(3.0, true),
                *knowledge_base2 = NULL;
  ...
  ck_assert_int_ne(knowledge_base1->active->length,
                   knowledge_base2->active->length);
...
START_TEST(create_new_rules_test) {
  ...
  Scene *observed = scene_constructor(true),
...
START_TEST(to_string_test) {
  ...
  ck_assert_str_eq(knowledge_base_string,
                   "Knowledge Base:\n"
...
START_TEST(to_prudensjs_test) {
  ...
  const char *const expected_empty_result =
      "{\"type\": \"output\", \"kb\": [], \"code\": \"\", "
      "\"imports\": \"\", \"warnings\": [], \"customPriorities\": []}";

  const char *const expected_result =
      "{\"type\": \"output\", \"kb\": [{\"name\": \"Rule2\", "
      "\"body\": [{\"name\": \"bat\", \"sign\": true, \"isJS\": false, "
      "\"isEquality\": false, "
      "\"isInEquality\": false, \"isAction\": false, \"arity\": 0}, {\"name\": "
      "\"mammal\", "
      "\"sign\": true, \"isJS\": false, \"isEquality\": false, "
      "\"isInEquality\": false, "
      "\"isAction\": false, \"arity\": 0}, {\"name\": \"cave\", \"sign\": "
      "true, \"isJS\": false, "
      "\"isEquality\": false, \"isInEquality\": false, \"isAction\": false, "
      "\"arity\": 0}, "
      "{\"name\": \"bird\", \"sign\": false, \"isJS\": false, \"isEquality\": "
      "false, "
      "\"isInEquality\": false, \"isAction\": false, \"arity\": 0}], \"head\": "
      "{\"name\": \"fly\", "
      "\"sign\": true, \"isJS\": false, \"isEquality\": false, "
      "\"isInEquality\": false, "
      "\"isAction\": false, \"arity\": 0}}, {\"name\": \"Rule1\", \"body\": ["
      "{\"name\": \"eagle\", \"sign\": true, \"isJS\": false, \"isEquality\": "
      "false, "
      "\"isInEquality\": false, \"isAction\": false, \"arity\": 0}, {\"name\": "
      "\"bird\", "
      "\"sign\": true, \"isJS\": false, \"isEquality\": false, "
      "\"isInEquality\": false, "
      "\"isAction\": false, \"arity\": 0}], \"head\": {\"name\": \"fly\", "
      "\"sign\": true, "
      "\"isJS\": false, \"isEquality\": false, \"isInEquality\": false, "
      "\"isAction\": false, "
      "\"arity\": 0}}, {\"name\": \"Rule0\", \"body\": [{\"name\": "
      "\"penguin\", \"sign\": true, "
      "\"isJS\": false, \"isEquality\": false, \"isInEquality\": false, "
      "\"isAction\": false, "
      "\"arity\": 0}, {\"name\": \"bird\", \"sign\": true, \"isJS\": false, "
      "\"isEquality\": false, "
      "\"isInEquality\": false, \"isAction\": false, \"arity\": 0}], \"head\": "
      "{\"name\": \"fly\", \"sign\": false, "
      "\"isJS\": false, \"isEquality\": false, \"isInEquality\": false, "
  ...
  char *knowledge_base_prudensjs_string =
      knowledge_base_to_prudensjs(knowledge_base);
...
Suite *knowledge_base_suite() {
  Suite *suite;
  TCase *create_case, *add_rule_case, *copy_case, *create_new_rules_case,
      *convert_case;
