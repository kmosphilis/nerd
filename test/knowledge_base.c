...
START_TEST(to_prudensjs_test) {
    ...
    const char *expected_result = "[{\\\"name\\\": \\\"Rule1\\\", "
    "\\\"body\\\": [{\\\"name\\\": \\\"Penguin\\\", \\\"sign\\\": true, \\\"isJS\\\": false, "
