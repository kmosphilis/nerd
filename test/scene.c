...
START_TEST(add_test) {
  ...
  Literal *literal = literal_constructor("Penguin", 1), *copy1, *copy2, *copy3,
          *copy4, *copy;
...
START_TEST(delete_test) {
  ...
  Literal *l1 = literal_constructor("Penguin", 1),
          *l2 = literal_constructor("Antarctica", 1),
          *l3 = literal_constructor("Bird", 1),
          *l4 = literal_constructor("Fly", 0), *c1, *c2, *c3, *c4,
          *removed_literal;
...
START_TEST(copy_test) {
  ...
  ck_assert_int_eq(scene_is_taking_ownership(scene1),
                   scene_is_taking_ownership(scene2));
...
START_TEST(combine_test) {
  ...
  ck_assert_int_eq(scene_is_taking_ownership(scene1),
                   scene_is_taking_ownership(result));
  ck_assert_int_eq(scene_is_taking_ownership(scene2),
                   scene_is_taking_ownership(result));
  ck_assert_int_eq(scene1->size, 4);
  ck_assert_int_eq(scene2->size, 4);
  ...
  ck_assert_int_eq(scene_is_taking_ownership(scene1),
                   scene_is_taking_ownership(result));
  ck_assert_int_ne(scene_is_taking_ownership(scene2),
                   scene_is_taking_ownership(result));
  ck_assert_int_eq(scene1->size, 4);
  ck_assert_int_eq(scene2->size, 4);
  ck_assert_int_eq(result->size, 5);
...
START_TEST(difference_test) {
  Scene *scene1 = scene_constructor(true), *scene2 = scene_constructor(true),
        *expected1 = scene_constructor(true),
        *expected2 = scene_constructor(true), *result = NULL;
  Literal *l1 = literal_constructor("Penguin", 1),
          *l2 = literal_constructor("Albatross", 1),
          *l3 = literal_constructor("Antarctica", 1),
          *l4 = literal_constructor("Bird", 1),
...
START_TEST(intersect_test) {
  Scene *scene1 = scene_constructor(true), *scene2 = scene_constructor(true),
        *scene3 = scene_constructor(true), *scene4 = scene_constructor(true),
        *expected1 = scene_constructor(true),
        *expected2 = scene_constructor(true),
        *expected3 = scene_constructor(true), *result = NULL;
  Literal *l1 = literal_constructor("Penguin", 1),
          *l2 = literal_constructor("Albatross", 1),
          *l3 = literal_constructor("Antarctica", 1),
          *l4 = literal_constructor("Bird", 1),
  ...
  ck_assert_int_eq(scene_is_taking_ownership(scene1),
                   scene_is_taking_ownership(result));
  ck_assert_int_eq(scene_is_taking_ownership(scene3),
                   scene_is_taking_ownership(result));
  ck_assert_scene_eq(result, expected2);
  scene_destructor(&result);
  ...
  ck_assert_int_eq(scene_is_taking_ownership(scene1),
                   scene_is_taking_ownership(result));
  ck_assert_int_eq(scene_is_taking_ownership(scene4),
                   scene_is_taking_ownership(result));
  ck_assert_scene_notempty(scene1);
  ...
  scene_intersect(scene1, scene2, &result);
  ck_assert_int_ne(scene_is_taking_ownership(scene1),
                   scene_is_taking_ownership(result));
  ck_assert_int_eq(scene_is_taking_ownership(scene2),
                   scene_is_taking_ownership(result));
  ck_assert_scene_eq(result, expected1);
...
START_TEST(subset_check_test) {
  ...
  Literal *l1 = literal_constructor("eagle", true),
          *l2 = literal_constructor("bird", true),
          *l3 = literal_constructor("wings", true),
          *l4 = literal_constructor("feathers", true),
...
START_TEST(opposed_literals_test) {
  Scene *scene1 = scene_constructor(true), *scene2 = scene_constructor(true),
        ...
        *expected2 = scene_constructor(true), *result = NULL;
  Literal *l1 = literal_constructor("Penguin", 1),
          *l2 = literal_constructor("Bird", 1),
          *l3 = literal_constructor("Fly", 0),
          *l4 = literal_constructor("Fly", 1),
          *l5 = literal_constructor("Antarctica", 1),
          *l6 = literal_constructor("Antarctica", 0), *c1, *c2, *c3, *c4, *c5,
          *c6;
