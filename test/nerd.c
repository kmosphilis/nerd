...
#define NUMBER_OF_ACTIVE 3
#define NUMBER_OF_INACTIVE 2
...
START_TEST(construct_destruct_test) {
    ...
    nerd_constructor(&nerd, DATASET, 1, 10.0, 3, 100, 50, 0.5, 1.5, 0);
    ...
    ck_assert_int_eq(nerd.breadth, 0);
    ck_assert_int_eq(nerd.depth, 0);
    ck_assert_float_infinite(nerd.promotion_weight);
    ck_assert_float_infinite(nerd.demotion_weight);
    ck_assert_int_eq(nerd.partial_observation, 0);
    ck_assert_ptr_null(nerd.sensor.environment);
    ck_assert_int_eq(nerd.sensor.reuse, 0);
    ck_assert_ptr_null(nerd.sensor.filepath);
    ck_assert_float_infinite(nerd.knowledge_base.activation_threshold);
    ck_assert_knowledge_base_empty(&(nerd.knowledge_base));

    nerd_constructor(nerd_ptr, DATASET, 1, 10.0, 3, 100, 50, 0.5, 1.5, 0);
    ck_assert_int_eq(nerd.breadth, 0);
    ck_assert_int_eq(nerd.depth, 0);
    ck_assert_float_infinite(nerd.promotion_weight);
    ck_assert_float_infinite(nerd.demotion_weight);
    ...
    nerd_constructor(&nerd, NULL, 1, 10.0, 3, 100, 50, 0.5, 1.5, 0);
    ck_assert_int_eq(nerd.breadth, 0);
    ck_assert_int_eq(nerd.depth, 0);
    ck_assert_float_infinite(nerd.promotion_weight);
    ck_assert_float_infinite(nerd.demotion_weight);
    ...
    nerd_constructor(nerd_ptr, NULL, 1, 10.0, 3, 100, 50, 0.5, 1.5, 0);
    ck_assert_int_eq(nerd.breadth, 0);
    ck_assert_int_eq(nerd.depth, 0);
    ck_assert_float_infinite(nerd.promotion_weight);
    ck_assert_float_infinite(nerd.demotion_weight);
...
START_TEST(construct_from_file) {
    ...
    nerd_constructor_from_file(&nerd, "../test/data/nerd_input1.txt", 2);
    ...
    nerd_constructor_from_file(&nerd, "../test/data/nerd_input2.txt", 1);
    ck_assert_int_eq(nerd.breadth, 3);
    ck_assert_int_eq(nerd.depth, 100);
    ...
    *inactive_rules[NUMBER_OF_INACTIVE] = {"(turkey) => -fly (9.0000)",
    ...
    nerd_constructor_from_file(&nerd, NULL, 1);
    ck_assert_int_eq(nerd.breadth, 0);
    ck_assert_int_eq(nerd.depth, 0);
    ck_assert_float_infinite(nerd.promotion_weight);
    ck_assert_float_infinite(nerd.demotion_weight);
    ...
    nerd_constructor_from_file(nerd_ptr, DATASET, 0);
    ck_assert_ptr_null(nerd_ptr);

    nerd_constructor_from_file(nerd_ptr, NULL, 0);
    ck_assert_ptr_null(nerd_ptr);

    nerd_constructor_from_file(&nerd, "../file-that-doesnt_exist.txt", 1);
    ck_assert_int_eq(nerd.breadth, 0);
    ck_assert_int_eq(nerd.depth, 0);
    ck_assert_float_infinite(nerd.promotion_weight);
    ck_assert_float_infinite(nerd.demotion_weight);
...
START_TEST(to_file_test) {
    ...
    nerd_constructor(&nerd, DATASET, 1, 15.0, 3, 50, 1, 1.5, 4.5, 1);
