 ...
 * 
 * @param rule_queue The RuleQueue to be constructed.
 */
 ...
 * @param source The RuleQueue to be copied.
 */
 ...
 * @param rule The Rule to be enqueued.
 */
 ...
 * @return The string format of the given RuleQueue. Use free() to deallocate this string.
 */
